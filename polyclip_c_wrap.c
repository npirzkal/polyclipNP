...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__polyclip

#else
#  define SWIG_init    init_polyclip

#endif
#define SWIG_name    "_polyclip"
...
SWIGINTERN PyObject *_wrap_polyclip_multi4(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOOOOOO:polyclip_multi4",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8,&obj9,&obj10,&obj11,&obj12)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1
    };
  ...
  {
    array24 = obj_to_array_no_conversion(obj12, NPY_INT);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"polyclip_multi4", _wrap_polyclip_multi4, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
